...
console.log(
  `I am ${fullName} from ${city}, ${country}. Latitude(${lat}), Longitude(${lng})`,
);
console.log("------");
...
console.log(
  "Part 1 Using methods taught in class, turn the users object into an array:",
);
// Instructions
...
console.log(
  "Part 2 Modify the outcome of part 1, by multipling the user’s ID by 2.",
);
...
console.log(
  "Issue: It does not call super() before using this. In JavaScript, if you define a constructor method in a subclass, you need to call super() before you can use this. Failing to do so will cause a reference error.",
);
console.log("---");
...
console.log(
  "Correct: This option correctly calls super(name) before using this. It passes the name to the parent Dog class's constructor, and then it sets the size property on the Labrador instance. This is the correct way to extend the Dog class.",
);
console.log("---");
...
console.log(
  "Issue: The parameter name isn't defined in the constructor(size) method but is passed to super(name). This would result in name being undefined, leading to unexpected behavior.",
);
console.log("---");
...
console.log(
  "Issue: Similar to option 1, this does not call super() before using this. It tries to set this.name and this.size directly without first calling the parent class's constructor, which is necessary when extending another class.",
);
console.log("------");
...
console.log(
  "Comparing two arrays console.log([2] === [2]) => Expected output: False",
);
...
console.log(
  "Comparing two objects console.log({} === {}) => Expected output: False",
);
console.log(`Explanation:
...
console.log(
  "Part 2 What is, for each object below, the value of the property number and why?",
);
...
console.log(
  "Example of creating an instance of the Mammal class and using the sound method",
);

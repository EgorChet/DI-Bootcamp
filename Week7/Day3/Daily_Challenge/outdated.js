...
const joinWords = (morse, userInput) => {
  toJs(morse)
    ...
    .then((morseTranslation) => {
      ...
      // Create a div element to hold the original string
      const originalDiv = document.createElement("div");
      // Set the inner HTML of the div to the original string
      ...
      // Set the inner HTML of the morseDiv to the joined Morse code
      morseDiv.innerHTML = `<strong>Morse Code:</strong> <br>${joinedMorse}`;
      // Append the div to the body of the page

...
const cloneGroceries = () => {
  ...
  console.log(
    `groceries totalPrice: ${groceries.totalPrice}, shopping totalPrice: ${shopping.totalPrice}`,
  );

  // Change the value of the paid key to false.
  groceries.other.paid = false;
  console.log(
    `groceries paid: ${groceries.other.paid}, shopping paid: ${shopping.other.paid}`,
  );
};

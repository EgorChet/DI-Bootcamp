...
// Instructions
// Part I
console.log("Part 1 The function should loop through the array of object and return the first car with the name “Honda”")
...
const getCarHonda = (carInventory) => {
    ...
    return car ? `This is a ${car.car_make} ${car.car_model} from ${car.car_year}.` : 'No Honda cars found.';
};
...
// Part II
console.log('Part 2 The function should return an inventory that is sorted by car_year, ascending')
